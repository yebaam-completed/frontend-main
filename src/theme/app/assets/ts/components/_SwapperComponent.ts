...
//     try {
//       const alreadyPended = parentElement.querySelector(elementIdSelector) !== null;
//       if (!alreadyPended) {
//         console.log(`Appending or prepending element with ID: ${this.element.id}`);
//         if (mode === 'prepend') {
...
//       }
//     } catch (error) {
//       console.error(`Invalid selector: ${elementIdSelector}`, error);
//     }
//   }
...
//     console.log('createInstance called with selector:', selector);

//     if (!selector) {
//       console.error('Selector is empty in createInstance');
//       return;
//     }
...
//     let place = SwapperComponent.getInstance(item);
//     if (!place) {
//       console.log('Creating new SwapperComponent instance');
//       place = new SwapperComponent(item, options, queries);
//     }
//     return place;
//   }
